					...
					Microsoft.Maps.loadModule('CanvasOverlayModule', function () {
						var overlay = new CanvasOverlay(function (canvas) {
							...
							for (var i = 0, len = points.length; i < len; i++) {
								...
								ctx.lineWidth = option.strokeThickness ? option.strokeThickness : 1;
								ctx.strokeStyle = option.strokeColor ? option.strokeColor : 'black';
						...
						Microsoft.Maps.Events.addHandler(map[mapReference], 'mousemove', function (e) {
							...
							if (selectedIdx >= 0) {
								...
								infobox[infoboxCreateType].setOptions(infobox[infoboxCreateType].optionList[selectedIdx])
							}
						});
